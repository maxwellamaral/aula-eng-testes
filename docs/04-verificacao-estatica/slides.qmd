...
| **Teste de mesa**^[O **teste de mesa** (*desk checking*) é uma técnica de **verificação estática informal** na qual a própria pessoa autora e/ou revisores percorrem logicamente um artefato de software (como código-fonte, algoritmo, modelo ou requisito).] | O fluxo lógico revela uma questão no artefato? |
